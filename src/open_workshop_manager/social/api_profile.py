...
def _profile_rights_payload(row: account.Account) -> ProfileRightsRead:
    return ProfileRightsRead(
        ...
        publish_modpacks=bool(getattr(row, "publish_modpacks", False)),
        change_authorship_modpacks=bool(getattr(row, "change_authorship_modpacks", False)),
        change_self_modpacks=bool(getattr(row, "change_self_modpacks", False)),
        change_modpacks=bool(getattr(row, "change_modpacks", False)),
        delete_self_modpacks=bool(getattr(row, "delete_self_modpacks", False)),
        delete_modpacks=bool(getattr(row, "delete_modpacks", False)),
